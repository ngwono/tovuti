...
'https://jadaecommercebackend.azurewebsites.net/');
...
(function() {
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper){
        ...
        $urlRouterProvider.otherwise('/page/management-menu');

        //
        // Application Routes
        // -----------------------------------
        $stateProvider
          .state('page.management-menu', {
              url: '/management-menu',
              title: 'Management Menu',
              templateUrl: 'app/pages/management-menu.html',
              resolve: helper.resolveFor('angular-carousel','oitozero.ngSweetAlert','loaders.css', 'spinkit')
          })
          .state('page.product-type', {
              url: '/product-types',
              title: 'Product Types',
